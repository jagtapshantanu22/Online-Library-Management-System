...
public class Home extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
        ...
        public Home() {
            ...
            bookdetails.setForeground(Color.LIGHT_GRAY);
            mnRecord.add(bookdetails);

            JMenuItem studentdetails = new JMenuItem("Student Details");
            studentdetails.setBackground(new Color(211, 211, 211));
            studentdetails.setForeground(Color.LIGHT_GRAY);
            ...
            l1.setBounds(158, 30, 701, 80);
            contentPane.add(l1);

            JLabel l2 = new JLabel("");
            l2.setVerticalAlignment(SwingConstants.TOP);
            ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/addbooks1.jpg"));
            ...
            ImageIcon i4  = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/stat.jpg"));
            ...
            ImageIcon i7  = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/addstu.png"));
            ...
            panel.setBorder(new TitledBorder(new LineBorder(new Color(15, 79, 234), 2), "Operation", TitledBorder.LEADING,
            ...
            ImageIcon i10  = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/Issuebookf.png"));
            ...
            ImageIcon i13  = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/RetBook.jpg"));
            ...
            ImageIcon i16  = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/Aboutus.jpg"));
            ...
            panel2.setBorder(new TitledBorder(new LineBorder(new Color(15, 79, 234), 2), "Action", TitledBorder.LEADING,
				TitledBorder.TOP, null, new Color(10, 0, 3)));
